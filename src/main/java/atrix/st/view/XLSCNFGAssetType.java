...
public class XLSCNFGAssetType  extends AbstractExcelXView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, XSSFWorkbook wb,
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"AssetTypeMaster.xlsx\"");
        ...
        hcell.setCellValue("V_GUAR_FLAG");
        hcell.setCellStyle(bStyle);
