...
public class XLSCNFGRatingModelMapping extends AbstractExcelXView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, XSSFWorkbook wb,
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"RatingModelMapping.xlsx\"");
        ...
        hcell.setCellValue("M_RDM_MODEL");
        hcell.setCellStyle(bStyle);
