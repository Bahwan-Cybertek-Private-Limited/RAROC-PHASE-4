...
public class XLSCNFGRestructuredMaster extends AbstractExcelXView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, XSSFWorkbook wb,
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"RestructuredMaster.xlsx\"");
