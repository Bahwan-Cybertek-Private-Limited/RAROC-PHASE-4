...
public class XLSCNFGBusinessUnit extends AbstractExcelXView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, XSSFWorkbook wb,
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"BusinessUnitMaster.xlsx\"");
        ...
        hcell.setCellValue("V_DESC");
        hcell.setCellStyle(bStyle);

        hcell = hrow.createCell(2);
        hcell.setCellValue("F_LATEST_IND");
        hcell.setCellStyle(bStyle);
