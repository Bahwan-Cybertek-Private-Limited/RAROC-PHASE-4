...
public class XLSCNFGGuarantor extends AbstractExcelXView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, XSSFWorkbook wb,
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"GuarantorMaster.xlsx\"");
        ...
        hcell.setCellValue("V_MAPPING_COL");
        hcell.setCellStyle(bStyle);
