...
public class XLSCNFGInternalRatingModel extends AbstractExcelXView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, XSSFWorkbook wb,
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"InternalRatingModel.xlsx\"");
        ...
        hcell.setCellValue("V_RDM_INT_RAT");
