...
$(function () {
    ...
    var grid = $("#grid1"),
            URL = 'raroc/view/grid/etb?ref=' + $("#ref").val(),
            params0 = {
                name: 'id',
                sorttype: 'int',
                hidden: true
...
//    },
            ...
            params34 = {
                name: 'relationTotal',
                label: 'Total Relationship RAROC',
                align: 'center',
                formatter: totalFormat1,
                sortable: false
            },
            options = {
                ...
                colModel: [params0, params1, params2, params3, params4, params5, params6, params7, params8, params9,
                    ...
                    params29, params30, params31, params32, params33, params34],
        ...
        refresh: false
            ...
            .navButtonAdd('#pager1', {
                ...
                onClickButton: function () {
                    window.location.href = 'raroc/etb/view?ref=' + $("#ref").val() + '&viewType=XLS';
                }
            })
            .navButtonAdd('#pager1', {
                caption: "PDF",
