...
$(function () {
    ...
    var grid = $("#extgrid"), URL = 'rarocConfig/grid/listExternalRating';
  ...
  $("#approve").ajaxForm(formOptions);
    ...
    grid.jqGrid(options).navGrid("#extpager", {
        add: false,
        edit: false,
        del: false
    }, {}, {}, {}, {
        sopt: ['eq', 'ne', 'cn', 'nc', 'bw', 'ew', 'nu', 'nn']
    }).navButtonAdd('#extpager', {
        caption: "Template",
        buttonicon: "fa fa-file-excel-o",
        onClickButton: function () {
                  window.location.href = "rarocConfig/listExternalRating/doc";
