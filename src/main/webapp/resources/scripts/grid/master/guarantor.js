...
$(function () {
    ...
    var grid = $("#guagrid"), URL = 'rarocConfig/grid/listGuarantorMaster';
    ...
    grid.jqGrid(options).navGrid("#guapager", {
        add: false,
        edit: false,
        del: false
    }, {}, {}, {}, {
        sopt: ['eq', 'ne', 'cn', 'nc', 'bw', 'ew', 'nu', 'nn']
    }).navButtonAdd('#guapager', {
        caption: "Template",
        buttonicon: "fa fa-file-excel-o",
        onClickButton: function () {
                  window.location.href = "rarocConfig/listGuarantorMaster/doc";
