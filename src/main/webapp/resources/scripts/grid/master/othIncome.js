 ...
 */
$(function () {
    var grid = $("#imgrid"), URL = 'rarocConfig/grid/listOthIncomeMaster';
    ...
    grid.jqGrid(options).navGrid("#impager", {
        add: false,
        edit: false,
        del: false
    }, {}, {}, {}, {
        sopt: ['eq', 'ne', 'cn', 'nc', 'bw', 'ew', 'nu', 'nn']
    }).navButtonAdd('#impager', {
        caption: "Template",
        buttonicon: "fa fa-file-excel-o",
        onClickButton: function () {
                  window.location.href = "rarocConfig/listOthIncomeMaster/doc";
