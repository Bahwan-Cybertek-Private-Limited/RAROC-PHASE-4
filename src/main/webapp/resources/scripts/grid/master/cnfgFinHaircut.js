 ...
 */
$(function () {
    var grid = $("#masterfhgrid"), URL = 'rarocConfig/grid/listCNFGFinHaircut';
    ...
    params1 = {
        ...
        loadComplete: function () {
            ...
            setGridWidth(grid, "#masterfhjqgrid");
        },
    ...
    grid.jqGrid(options).navGrid("#masterfhpager", {
        add: false,
        edit: false,
        del: false
    }, {}, {}, {}, {
        sopt: ['eq', 'ne', 'cn', 'nc', 'bw', 'ew', 'nu', 'nn']
    }).navButtonAdd('#masterfhpager', {
        caption: "Template",
        buttonicon: "fa fa-file-excel-o",
        onClickButton: function () {
                  window.location.href = "rarocConfig/listCNFGFinHaircut/doc";
