 ...
 */
$(function () {
    var grid = $("#fhgrid"), URL = 'rarocConfig/grid/listFinHaircut';
  ...
  $("#approve").ajaxForm(formOptions);
    ...
    grid.jqGrid(options).navGrid("#fhpager", {
        add: false,
        edit: false,
        del: false
    }, {}, {}, {}, {
        sopt: ['eq', 'ne', 'cn', 'nc', 'bw', 'ew', 'nu', 'nn']
    }).navButtonAdd('#fhpager', {
        caption: "Template",
        buttonicon: "fa fa-file-excel-o",
        onClickButton: function () {
                  window.location.href = "rarocConfig/listFinHaircut/doc";
