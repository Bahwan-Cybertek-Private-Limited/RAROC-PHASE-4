...
$(function () {
    ...
    var grid = $("#smgrid"), URL = 'rarocConfig/grid/listSensitivityIterationMaster';
  ...
  $("#approve").ajaxForm(formOptions);
    ...
    grid.jqGrid(options).navGrid("#smpager", {
        add: false,
        edit: false,
        del: false
    }, {}, {}, {}, {
        sopt: ['eq', 'ne', 'cn', 'nc', 'bw', 'ew', 'nu', 'nn']
    }).navButtonAdd('#smpager', {
        caption: "Template",
        buttonicon: "fa fa-file-excel-o",
        onClickButton: function () {
                  window.location.href = "rarocConfig/listSensitivityIterationMaster/doc";
