 ...
 */
$(function () {
    var grid = $("#rmmgrid"), URL = 'rarocConfig/grid/listRatingModelMapping';
  ...
  $("#approve").ajaxForm(formOptions);
    ...
    grid.jqGrid(options).navGrid("#rmmpager", {
        add: false,
        edit: false,
        del: false
    }, {}, {}, {}, {
        sopt: ['eq', 'ne', 'cn', 'nc', 'bw', 'ew', 'nu', 'nn']
    }).navButtonAdd('#rmmpager', {
        caption: "Template",
        buttonicon: "fa fa-file-excel-o",
        onClickButton: function () {
                  window.location.href = "rarocConfig/listRatingModelMapping/doc";
