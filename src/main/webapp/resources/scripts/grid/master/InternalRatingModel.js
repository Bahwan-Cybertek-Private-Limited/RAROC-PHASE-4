 ...
 */
$(function () {
    var grid = $("#irmgrid"), URL = 'rarocConfig/grid/listInternalRatingModel';
  ...
  $("#approve").ajaxForm(formOptions);
    ...
    grid.jqGrid(options).navGrid("#irmpager", {
        add: false,
        edit: false,
        del: false
    }, {}, {}, {}, {
        sopt: ['eq', 'ne', 'cn', 'nc', 'bw', 'ew', 'nu', 'nn']
    }).navButtonAdd('#irmpager', {
        caption: "Template",
        buttonicon: "fa fa-file-excel-o",
        onClickButton: function () {
                  window.location.href = "rarocConfig/listInternalRatingModel/doc";
