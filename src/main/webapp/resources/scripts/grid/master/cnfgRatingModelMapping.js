 ...
 */
$(function () {
    var grid = $("#masterrmmgrid"), URL = 'rarocConfig/grid/listCNFGRatingModelMapping';
    var 
    params1 = {
        name: 'id',
        index: 'id',
        ...
        caption: 'Rating Model Mapping',
        pager: '#masterrmmpager',
        rowNum: 13,
        rowList: [13, 30, 45],
        datatype: 'json',
        ...
        loadComplete: function () {
            ...
            setGridWidth(grid, "#masterrmmjqgrid");
        },
    ...
    grid.jqGrid(options).navGrid("#masterrmmpager", {
        add: false,
        edit: false,
        del: false
    }, {}, {}, {}, {
        sopt: ['eq', 'ne', 'cn', 'nc', 'bw', 'ew', 'nu', 'nn']
    }).navButtonAdd('#masterrmmpager', {
        caption: "Template",
        buttonicon: "fa fa-file-excel-o",
        onClickButton: function () {
                  window.location.href = "rarocConfig/listCNFGRatingModelMapping/doc";
