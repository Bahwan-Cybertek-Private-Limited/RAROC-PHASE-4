...
<div class="col-lg-12 col-md-12 marginTop">
    <div class="panel panel-breadcrumb">
        <div class="panel-body">
            <fmt:message key="breadcrumb.approveUser"/>
        </div>

    </div>
    <div class="panel panel-default">
        <div class="panel-body no-gutters">
            <c:url var="curl" value="/admin/approveUser"/>
            <form:form  commandName="userModel" action="${curl}" id="formAdmin" autocomplete="off" htmlEscape="true">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <br/><br/>
                    <div class="form-group">
                        <label for="status" class="col-lg-4 col-md-4 control-label"><fmt:message key="label.approve"/></label>
                        <div class="col-lg-8 col-md-8">
                            <form:select cssClass="form-control" path="status">
                                <form:option value="P" label="No"/>
                                <form:option value="A" label="Yes"/>
                            </form:select>
                        </div>
                    </div>
                    <c:if test="${authType == 'DB'}">
