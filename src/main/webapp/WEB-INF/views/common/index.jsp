                ...
                <div class="container-fluid">
 					<c:if test="${sessionScope.role=='Administrator'}">  
                         <sec:authorize url="<c:url value='/admin'/>">
                            <div class="col-lg-4 col-md-4"  style="padding-top: 80px;">
                    ...
                    <c:if test="${sessionScope.role=='AdminAuth'}"> 
                                ...
                                <div class="panel" style="background-color: #97144d">
                                    <div class="panel-heading">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 text-right">
                                                <div style="color: floralwhite"><h4>Master View / Edit</h4></div>
                                            </div>
                                        </div>
                                    </div>
                                    <a href="<c:url value='/rarocConfig'/>">
                                        <div id="ewiDetails" class="panel-footer">
                                            <span class="pull-left">View Details</span>
                                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                            <div class="clearfix"></div>
                                ...
                                <div class="panel" style="background-color: #97144d">
                                    <div class="panel-heading">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 text-right">
                                                <div style="color: floralwhite"><h4>Master Approve</h4></div>
                                            </div>
                                        </div>
                                    </div>
                                    <a href="<c:url value='/rarocMasterApprover'/>">
                                        <div id="ewiDetails" class="panel-footer">
                                            <span class="pull-left">View Details</span>
                                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                            <div class="clearfix"></div>
                   ...
                   <c:if test="${sessionScope.role=='RoleCorp'}"> 
                     <sec:authorize url="<c:url value='/raroc'/>">
                        <div class="col-lg-4 col-md-4"  style="padding-top: 80px;">
                            <div class="panel"  style="background-color: #97144d">
                                <div class="panel-heading">
